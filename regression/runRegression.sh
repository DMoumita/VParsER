...
export VIPER_HOME="/home/moumita/VParsER"
export VIPER_REG_HOME="/home/moumita/VParsER/regression"
cd $VIPER_REG_HOME
...
do
   ...
   do
      ...
      if [ $? == 0 ]
      then
	  echo $dir1/$file1:PASS>>$VIPER_REG_HOME/Report/Report_PASS
      else
	  echo $dir1/$file1:FAIL>>$VIPER_REG_HOME/Report/Report_FAIL
      fi
      rm $runFileName
   done
   rm file_list
